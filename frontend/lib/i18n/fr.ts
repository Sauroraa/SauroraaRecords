export const fr = {
  ...
  home: {
    ...
    how_steps: [
      ...
      { title: "Revenus", desc: "Touche jusqu'à 90% de chaque vente. Paiement mensuel garanti." }
    ],
  ...
  pricing: {
    ...
    plans: {
      artist_free: { name: "Artist Free", commission: "70/30", releases: "1 release/mois", support: "Support standard", analytics: false, branding: false },
